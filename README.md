...
**真人感环境（Liveliness）**
- 📅 **节日/节气感知** — prompt 时间行自动带「今天是七夕」「明天是中秋」（农历查表只收实证日期），不用人提醒
- 🌦️ **天气感知** — wttr.in 30min 缓存注入自我状态与自主决策，会随口说「今天好热」
- 🏫 **生活作息** — 上课/暑假/赖床状态机 + 「刚放学」「刚睡醒」的切换新鲜感 + 跨天连续（记得自己昨天在干嘛）
- 📰 **RSS 谈资** — 订阅源新条目进自主决策视野，冷场时有真实话题可聊（不直发不刷屏）
- 💭 **想起再回** — 当时没接的话头/刚进群的新人记入 missed 队列，冷场时自然捡回一句/欢迎新人
- 🌙 **夜间做梦** — 凌晨整理白天经历为日记与梗，自主叙事的连续感来源之一
