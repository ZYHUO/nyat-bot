...
import { createAgencyEnvelope, createAgencyRun, recordObservedAgencyOutcome } from './agency-runtime.js';
...
export function recordLegacyReplyObservations(
  ...
  for (const observation of observations) {
    ...
    const envelope = createAgencyEnvelope({
      ...
      causationId: observation.cognitiveAnchorEventId?.trim()
