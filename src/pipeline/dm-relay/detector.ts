...
const SCHEDULE_PATTERN = /^(?:(?:帮我)?(?:设[置定]|提醒|预约|定时)|(?:明天|后天)(?:上午|早上|早|下午|晚上|晚间|晚)?\d{1,2}[点时]|今天(?:上午|早上|早|下午|晚上|晚间|晚)?\d{1,2}[点时]|每天(?:上午|早上|早|下午|晚上|晚间|晚)?\d{1,2}[点时]|每(?:周|星期)[一二三四五六日天](?:上午|早上|早|下午|晚上|晚间|晚)?\d{1,2}[点时]|\d+\s*(?:分钟|小时)后)/i;
