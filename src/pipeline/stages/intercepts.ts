 ...
 */
/**
 * **收窄过的**判据（2026-09-23，部署后拿真实语料回来校）。
 *
 * 第一版写得太宽，用 5000+ 条真实入站回测发现大量误伤：
 *   "能听歌就够了👌"            ← "够了"，但这是满意
 *   "16+512足够了"              ← "够了"，技术讨论
 *   "跑重复任务都能降出个大的来"   ← "重复"，技术讨论
 *   "请勿重复发送内容"           ← "重复"，是群规不是纠正 bot
 *   "我是服了 小火箭连接的快"      ← "服了"，闲聊
 *   "好安静，来聊天嘛喵qwq"       ← "安静"，意思相反
 *   "被整无语到冒冷汗"           ← "无语"
 *
 * 而真正的纠正（全部来自真实日志）长这样：
 *   @hunhebi_bot 闭嘴
 ...
 *   臭猫闭嘴
 *
 * 共同点：**主语明确指向 bot**（闭嘴/别说了 + 你/猫/直接 @），
 * 且都是祈使句。所以去掉所有'可以单独出现在陈述句里'的词，
 * 只留祈使/制止语义。
 */
