...
const USAGE_DEFAULTS: Record<string, AIUsage> = {
  ...
  // 心流「念头」反思(附加、非决策):快、非思考(2.7s/rc=0,不会被推理吃空)、非 GPT。
  // gemini-3.1-flash-lite 主,gpt-5.4-mini/stepfunjudge 兜底(尽量不用 GPT)。
  heart_reflect:    { label: 'gemini31lite',  backups: ['sub2gpt54mini', 'stepfunjudge'], timeout: 15_000, maxTokens: 200,  temperature: 0.3 },
